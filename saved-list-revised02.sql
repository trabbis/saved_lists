...
---------------------------------------
-- 1. Getting customer list from items table  -- 183,745
--------------------------------------- 
SELECT distinct user_id AS borrower_id, FROM public.items 
